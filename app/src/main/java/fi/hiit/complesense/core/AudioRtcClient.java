...
/**
 * Created by hxguo on 9/8/14.
 */
public class AudioRtcClient
{
    ...
    private final static String TAG = "AudioRtcClient";
                ...
                if (s.equals("id")) {
                    ...
                    if (!peers.containsKey(from)) {
                        ...
                        if (endPoint != MAX_PEER) {
                            ...
                            //setOnlyPeer(new Peer(from, endPoint));
    ...
    public void setOnlyPeer(Peer onlyPeer) {
        this.onlyPeer = onlyPeer;
        mListener.onOnlyPeer(onlyPeer);
    }
...
//                pc.addStream()
        ...
        {
            Log.d(TAG, "onAddStream " + dataChannel.label());
        }

        public Peer(String id, int endPoint)
        {
            Log.i(TAG,"new Peer: "+id + " " + endPoint);
            this.pc = factory.createPeerConnection(iceServers, pcConstraints, this);
            this.id = id;
            this.endPoint = endPoint;
            this.dataChannel = pc.createDataChannel("sendDataChannel", new DataChannel.Init() );
    ...
    public AudioRtcClient(RTCListener listener, String host)
    {
        mListener = listener;
        factory = new PeerConnectionFactory();
        Log.i(TAG,"AudioRtcClient()");
